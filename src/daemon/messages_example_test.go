...
func ExampleIntroductionMessage() {
	...
	pk := cipher.MustPubKeyFromHex("025d096499390a1924969f0991b1e0fd5f37c9ec54f7830f10fa8d911a51bb1e4b")

	var message = NewIntroductionMessage(1234, 5, 7890, pk, "mdl:0.24.1", params.VerifyTxn{
		BurnFactor:          2,
