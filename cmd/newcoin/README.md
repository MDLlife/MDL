...
### Create New Coin
When using the `newcoin` command, you should run it from the `$GOPATH/src/github.com/MDLlife/MDL` folder to utilise the built in default templates.
...
It will also use the built-in defaul options (specified above) and draw template configuration from `$GOPATH/src/github.com/MDLlife/MDL/template`
