...
The CLI command APIs can be used directly from a Go application, see [Skycoin CLI Godoc](https://godoc.org/github.com/MDLlife/MDL/src/cli).
...
```bash
$ cd $GOPATH/src/github.com/MDLlife/MDL/cmd/skycoin-cli
$ go install ./...
```
...
Creates a deterministic wallet using the [Skycoin deterministic address generator](https://github.com/MDLlife/MDL/wiki/Deterministic-Keypair-Generation-Method).
